...
exports.sendActiveMail  = function (to,token,username) {
	...
	var mailOptions = {
		...
		html: '<div style="margin:0 auto; width:552px;"><table width="100%" style="background-color:#efefef;">'+
			  ...
			  '<tr><td align="center"><a href="http://'+config.hostname+':3000/users/user/activeUser?key='+token+'&username='+username+'" style="width:100px;text-align:center;font-size:12px;">立即激活账号</a></td></tr>'+		
			  '</table></div>'
	};
...
exports.sendResetPassMail   = function (to, token,username) {
	...
	var mailOptions = {
		...
		html: '<div style="margin:0 auto; width:552px;"><table width="100%" style="background-color:#efefef;">'+
			  ...
			  '<tr><td style="border-top:1px #f1f4f6 solid; padding: 6px 0 12px 0;" align="center" class="padding"></td></tr>'+		
			  '<tr><td align="center"><a href="http://'+config.hostname+':3000/users/user/resetPass?key='+token+'&username='+username+'" style="width:100px;text-align:center;font-size:12px;">密码重置</a></td></tr>'+		
			  '</table></div>'
	};
